...
_Orion switches to the next slide, which displays the same three objects, but this time complete with overlaid captions which point out the abnormalities in each object._
