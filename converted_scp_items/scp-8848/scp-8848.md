# SCP-8848
Item Number: SCP-8848
Rating: 9
Series: series-9
Tags: _cc, _licensebox, artifact, ectoentropic, electromagnetic, safe, scp, transmission
...
![Coil_with_ferrite_core_from_dimmer.jpg](http://scp-sandbox-3.wikidot.com/local--files/maxwellism/Coil_with_ferrite_core_from_dimmer.jpg)
SCP-8848-A coiled circularly.
* * *
**Item #:** SCP-8848
**Object Class:** Safe
**Special Containment Procedures:** The original piece of SCP-8848 is to be kept within a standard storage unit for low-risk anomalous items with electromagnetic-proof shield.
Replicating SCP-8848 must obtain the approval from the research team in advance. All replicas and resultant products must be explicitly documented.
**Description:** SCP-8848 is a pair of induction coils (interchangeably designated -A and -B) that are identical in shape, weight, and all other physical properties, and both of them are achiral.
SCP-8848-A and -B can both function normally and exhibit qualities like common electromagnets and induction coils, which can electrify other charged bodies by inducing electromotive force in their circuits within their fields of magnetic influence.
However, when the distance between SCP-8848-A and -B draws farther, their mutual induction effect always perpetuates, and seems to be everlasting no matter how long the distance is. The intertwinement also cannot be disrupted by common means of electromagnetic screening, such as metal containers and webs. The induction effect between -A and -B is instantaneous, which means, unlike common coil pairs in transformers, the current (and voltage) in -A and -B unconditionally run in sync, which makes them transcending the principle of locality[1](javascript:;).
**Experiment Logs:**
**Approaches:** SCP-8848-A was transported to Site-CN-34, 126██ km in direct distance across the Earth from SCP-8848-B. It was then put into a reinforced containment unit with a telepathic shielding alloy lining inside a Faraday cage. A versatile weak current generator was applied to SCP-8848-A; a multimeter was connected to SCP-8848-B.
**Outcomes:** Either on direct currents (DC) or alternating currents (AC), the readings on the multimeter remained in immediate sync with the current generator's configuration. It is assumed that SCP-8848 works regardless of the shielding methods.
**Approaches:** During an outer space expedition, it was requested that SCP-8848-B be taken to at least outside the Karman line[2](javascript:;), while SCP-8848-A remained on Earth, in order to test their ability to surpass an extreme distance and withstand the electromagnetic distortion from the ionosphere and space radiations.
**Outcomes:** The spaceship went beyond the Moon after 7 days. A radio modulator once used to generate electric currents from audio input was connected to SCP-8848-B, and the expedition team used it to speak to the ground control center.
The conversation is transcribed below, with all impertinent information removed.
* * *
**Squadron:** Here it is. Here it is. You can just leave alone the wave filter. We don't need it for now. _(volume up)_ Command, can you hear us?
**Control:** Yes, we can hear you. The voice is clear.
**Squadron:** What about the signal fidelity? As compared to the normal channel?
**Control:** One moment. _(pauses)_ It was… pretty fine. Uh, the voice is somehow clearer coming from the coil.
...
**Squadron:** Oh my gosh. _(clattering sound)_ Do you know what does this mean, Harrison? _(Harrison was speaking.)_ It is likely exceeding the speed of light. You don't know what this means, Arvin.
**Control:** We've got that. Likely this will persist even later on your way. Congrats!
**Approaches:** A copy of SCP-8848 was generated by [SCP-038](https://scp-wiki.wikidot.com/scp-038). The four coil instances were then cross-tested in all 6 possible combinations.
**Outcomes:** The two new coils did not respond either to the original -A or -B, but instead reacted between themselves and inherited the anomalous property. This phenomenon was noticed. Afterward, all replications of SCP-8848 are to be tagged respectively in pairs to avoid confusion.
**Approaches:** One duplication of SCP-8848 was disassembled, then remolded as a thinner strand of copper.
![QI_Coil_1.png](https://scp-sandbox-3.wikidot.com/local--files/maxwellism/QI_Coil_1.png)
One of the new coils weaved by the remolded threads.
**Outcomes:** The twisted wires appeared to keep the property intact. It was then hypothesized that the anomalous characteristics of SCP-8848 probably originated from its raw material.
However, all available analyses have shown that the material is chemically indistinguishable from common copper.
...
* * *
[▷ Level 4/8848 clearance only.](javascript:;)
[▽ Credentials verified.](javascript:;)
## Proposal for the Project Telekinetics
Project _Telekinetics_ (abbr. TEKI) is developed based on SCP-8848, a pair of electromagnetic coils that are identical in shape and functionality. They have the interchangeability to duplicate electronic signals within a single-narrative three-dimensional universe, e.g., our baseline reality, while bearing no downsides of time-lapse or distancing attenuation.
Project Telekinetics is to introduce a new technology to build an efficient brain-to-body interface. Preliminary steps will include:
  * An authorized Foundation personnel will serve as Side A.
...
* * *
The potentials of Project Telekinesis include:
  * **Rejuvenate:** Revitalize body disabilities and alleviate sufferings from diseases.
...
* * *
Footnotes
[1](javascript:;). A property that physical interactions only take effect within a local, adjacent scope.
[2](javascript:;). Usually known as the highest border of the Earth's atmosphere at around 100 km above the ground.