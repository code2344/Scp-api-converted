# SCP-7174
Item Number: SCP-7174
Rating: 11
Series: series-8
Tags: _cc, _licensebox, coldpostcon, computer, foundation-made, portal, safe, scp, spatial, tactical-theology, transmission
...
**Description:** SCP-7174 was an assortment[1](javascript:;) of 167 anomalously-enhanced wireless communication devices designed to facilitate communication between Lunar Area-32 and terrestrial Foundation assets. Each of these devices were capable of opening small[2](javascript:;) two-way Einstein-Rosen bridges[3](javascript:;) to fixed geocentric coordinates above the Earth's North Pole, whereupon the (otherwise unaltered) Foundation communication satellite FCOM-P022 would pick up and relay the signal transmitted by these devices to terrestrial network.
...
![Wpvg_chart_views.png](https://scp-wiki.wikidot.com/local--files/scp-7174/Wpvg_chart_views.png)
...
Footnotes
[1](javascript:;). Full manifest available upon formal request
[2](javascript:;). With diameters in the order of 10-15 meters. As reference, the diameter of a proton is roughly 1.7x10-15 meters.
[3](javascript:;). Colloquially known as "wormholes".